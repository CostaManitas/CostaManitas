...
import { MessageCircle, Gavel } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
          ...
          <div className="container mx-auto px-4 py-12">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="flex flex-wrap gap-4">
                  <a href={whatsapp} target="_blank" rel="noreferrer">
                      <button className="bg-black hover:bg-gray-800 text-white font-bold text-lg px-8 py-6 border-2 border-black shadow-[6px_6px_0px_0px_rgba(250,204,21,1)] hover:shadow-[3px_3px_0px_0px_rgba(250,204,21,1)] transition-all flex items-center">Contactar por WhatsApp · {phone}</button>
                    </a>

                  <a href={`tel:${site.phoneIntl}`}>
                    <button className="bg-white text-black font-bold px-6 py-3 border-2 border-black">
                      Llamar
                    </button>
                  </a>
                </div>
              ...
              <div className="hidden md:block relative">
                <div className="w-full h-64 bg-gray-100 border-4 border-black rounded-lg flex items-center justify-center">
                  <span className="font-black uppercase">IMAGEN DEL TRABAJO</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-12 bg-white border-b-4 border-black">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6"> 
              {categories.map((c, i) => (
                <div key={i} className="border-4 border-black p-6 bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all hover:-translate-y-1 rounded-lg overflow-hidden">
                  <h3 className="font-black text-lg uppercase leading-tight mb-3">{c}</h3>
                  <p className="font-bold text-gray-700">[Texto provisional — contenido pendiente]</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-12 bg-white border-b-4 border-black">
          <div className="container mx-auto px-4">
              ...
              {[1,2,3,4,5,6].map((n, index) => (
                <article key={n} className="border-4 border-black bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] overflow-hidden rounded-lg hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all">
                  <div className="relative">
                    <div
                      className="w-full h-36 bg-gradient-to-br from-gray-50 to-gray-100 border-b-4 border-black flex items-center justify-center relative overflow-hidden"
                      style={{
                        backgroundImage: `
                    ...
                    >
                      ...
                      <div className="relative z-10 bg-white border-4 border-black p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]" style={{ transform: `rotate(${index % 2 === 0 ? '-2deg' : '2deg'})` }}>
            ...
            <div className="text-center mt-8">
              <a href={whatsapp} target="_blank" rel="noreferrer">
                <button className="bg-black hover:bg-gray-800 text-white font-bold text-lg px-8 py-6 border-2 border-black shadow-[6px_6px_0px_0px_rgba(250,204,21,1)] hover:shadow-[3px_3px_0px_0px_rgba(250,204,21,1)] transition-all flex items-center justify-center mx-auto">Contactar por WhatsApp</button>
              </a>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 bg-white border-b-4 border-black">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl md:text-5xl font-black uppercase text-center mb-12 relative inline-block">Cómo trabajo
              <span className="absolute -bottom-2 left-0 w-full h-2 bg-yellow-400"></span>
            </h2>
        ...
        <section className="py-12 bg-white border-b-4 border-black">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl md:text-5xl font-black uppercase text-center mb-12 relative inline-block">¿Qué tipo de trabajos no realizo?
              <span className="absolute -bottom-2 left-0 w-full h-2 bg-yellow-400"></span>
            </h2>
        ...
        <section className="py-12 bg-white border-b-4 border-black">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl md:text-5xl font-black uppercase text-center mb-12 relative inline-block">¿Tienes un pequeño arreglo pendiente?
              <span className="absolute -bottom-2 left-0 w-full h-2 bg-yellow-400"></span>
            </h2>
            ...
            <div className="flex justify-center gap-4 mb-6">
              <a href={whatsapp} target="_blank" rel="noreferrer">
                <button className="bg-black hover:bg-gray-800 text-white font-bold text-lg px-8 py-6 border-2 border-black shadow-[6px_6px_0px_0px_rgba(250,204,21,1)] hover:shadow-[3px_3px_0px_0px_rgba(250,204,21,1)] transition-all flex items-center">Contactar por WhatsApp</button>
              </a>

              <a href={`tel:${site.phoneIntl}`}>
                <button className="bg-white text-black font-bold px-6 py-3 border-2 border-black hover:bg-gray-100 transition">Llamar</button>
              </a>
            </div>
